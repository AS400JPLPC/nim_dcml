...
##  mpd_t
##  350/351  *---> specifique industrie Gestion compatibilité AS400
type
  mpd_t* {.importc: "mpd_t", header: cHeader, bycopy.} = object
    ...
    entier* {.importc: "entier".}: uint8
    scale* {.importc: "scale".}: uint8
    nullable* {.importc: "nullable".}: bool
...
proc mpd_copy_data*(result: ptr mpd_t; a: ptr mpd_t; status: ptr uint32) {.cdecl,
    importc: "mpd_copy_data", header: cHeader.}
